<template>
  <div>
    <v-combobox
      ...
      class="mt-1"
    />
    <v-text-field outlined dense label="nameTm" v-model="news.nameTm" />
    <v-text-field outlined dense label="nameRu" v-model="news.nameRu" />
    <v-textarea outlined dense label="textTm" v-model="news.textTm" />
    <v-textarea outlined dense label="textRu" v-model="news.textRu" />
    <v-text-field outlined dense label="locationTm" v-model="news.locationTm" />
    <v-text-field outlined dense label="locationRu" v-model="news.locationRu" />
    <v-combobox
      outlined
      dense
      hide-details
