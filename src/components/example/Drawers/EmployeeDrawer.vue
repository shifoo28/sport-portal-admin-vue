<template>
  <div>
    <v-text-field
      ...
      class="mt-1"
    />
    <v-text-field outlined dense label="nameRu" v-model="employee.nameRu" />
    <v-text-field outlined dense label="jobTm" v-model="employee.jobTm" />
    <v-text-field outlined dense label="jobRu" v-model="employee.jobRu" />
    <v-text-field outlined dense label="workAtTm" v-model="employee.workAtTm" />
    <v-text-field outlined dense label="workAtRu" v-model="employee.workAtRu" />
...
export default {
  ...
  methods: {
    ...
    async saveInfo() {
      ...
      await axios
        .post("/federation-health-care-employees/", formData, {
          headers: {
