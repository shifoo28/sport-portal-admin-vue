<template>
  <v-app :style="{ background: $vuetify.theme.themes.dark.background }">
    <div style="margin: 20px">
      <nav-button @open-nav-drawer="openNavDrawer" icon="mdi-dumbbell" />

      <gym-table :headers="headers" :gyms="gyms" @show-full-info="openDialog" />
      ...
      >
        <v-card style="padding: 20px !important">
          <!-- Close dialog -->
          ...
          <v-row no-gutters>
            ...
            <v-col cols="12" md="6" sm="12" xs="12">
              ...
              <v-row no-gutters v-for="(value, key) in info" :key="key">
                <v-text-field
                  outlined
                  readonly
                  dense
            ...
            <v-col cols="12" md="6" sm="12" xs="12">
              ...
              <v-row no-gutters>
                <v-col cols="12" md="6" sm="6" class="pl-10 pr-5">
                  <v-img :src="url + '/' + info.imagePath1" max-height="250" />
                </v-col>
                <v-col cols="12" md="6" sm="6" class="pr-10 pl-5">
                  <v-img :src="url + '/' + info.imagePath2" max-height="250" />
                </v-col>
              </v-row>
              <!-- image3 image4 -->
              <v-row no-gutters class="mt-10">
                <v-col cols="12" md="6" sm="6" class="pl-10 pr-5">
                  <v-img :src="url + '/' + info.imagePath3" max-height="250" />
                </v-col>
                <v-col cols="12" md="6" sm="6" class="pr-10 pl-5">
                  <v-img :src="url + '/' + info.imagePath4" max-height="250" />
                </v-col>
              </v-row>
              <!-- image5 -->
      ...
      >
        ...
        <v-row no-gutters>
          ...
          <v-col cols="12" md="4" sm="4">
            ...
            <v-btn height="25" outlined @click="addItem('tel')"
          ...
          <v-col cols="12" md="4" sm="4">
            ...
            <v-row no-gutters v-for="(item, i) in sports" :key="i" class="mb-3">
              <v-text-field
            ...
            <v-btn height="25" outlined @click="addItem('sport')"
              >Add Sport</v-btn
            >
          </v-col>
        ...
        <v-row no-gutters class="mt-8">
          <v-col cols="12" md="4" sm="4">
            ...
            <v-row no-gutters v-for="(item, i) in openAt" :key="i" class="mb-3">
              <v-text-field
            ...
            <v-btn height="25" outlined @click="addItem('openAt')"
              >Add Work Time</v-btn
            >
          </v-col>
          <v-col cols="12" md="4" sm="4">
